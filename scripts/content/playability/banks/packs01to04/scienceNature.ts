  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        clue: { en: 'Which gene-editing system uses a guide RNA to direct the Cas9 enzyme to a chosen DNA sequence?', et: 'Milline geenimuutmise süsteem kasutab juht-RNA-d, et suunata Cas9-ensüüm valitud DNA-järjestuse juurde?' }, response: { en: 'CRISPR-Cas9', et: 'CRISPR-Cas9' }, acceptedVariants: { en: ['CRISPR'], et: ['CRISPR'] },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        clue: { en: 'Which familiar scale uses values below 7 for acidic solutions and above 7 for basic ones?', et: 'Millise tuntud skaala väärtused on happelisel lahusel alla 7 ja aluselisel lahusel üle 7?' }, response: { en: 'the pH scale', et: 'pH-skaala' }, acceptedVariants: { en: ['pH'], et: ['pH'] },
