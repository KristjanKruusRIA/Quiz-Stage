...
const DISTRIBUTIONS = {
  '01-history': [[27, 27], [17, 16], [16, 17]],
  '02-geography': [[27, 27], [16, 17], [17, 16]],
  '03-science-nature': [[27, 27], [17, 16], [16, 17]],
  '04-literature-language': [[27, 27], [16, 17], [17, 16]],
  '05-art-architecture': [[27, 26], [17, 17], [16, 17]],
  '06-music': [[26, 27], [17, 17], [17, 16]],
  '07-film-television': [[27, 26], [17, 17], [16, 17]],
  '08-sports-games': [[26, 27], [17, 17], [17, 16]],
  '09-food-drink': [[27, 26], [16, 17], [17, 17]],
  '10-technology-inventions': [[26, 27], [17, 16], [17, 17]],
  '11-politics-economics-society': [[27, 26], [16, 17], [17, 17]],
  '12-mythology-religion-philosophy': [[26, 27], [17, 16], [17, 17]],
...
export const PRODUCTION_BATCHES: readonly ProductionBatchDefinition[] = Object.freeze(
  TOPIC_DEFINITIONS.map(([id, packId, packName, topicFamily, subthemes, requiredOpenTdbClues]) => Object.freeze({
    ...
    boardClues: /^(?:0[1-9]|1[0-2])-/u.test(id) ? 600 : 500,
    finalClues: 0,
  })),
);
