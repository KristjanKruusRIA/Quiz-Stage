...
- `origin/main` remains `220c7d2` as freshly fetched on 2026-08-31: Adult/Estonia and the verified 1,600-clue accessible-easy corpus are already published. The medium/hard branch merged that exact baseline at `80b90e0`, and `origin/main` is still its ancestor.
- Reviewed History, Geography, Science & Nature, and Literature & Language are complete at 66 categories / 330 clues each, with exactly 33 medium / 33 hard per bank. Literature checkpoint 6 was independently approved and integrated as `d65ed12` + `5f8c184`; it closed the final source, answer-contract, category-title, ramp, and Estonian-copy findings without new breakage.
- Fresh primary gates at `5f8c184`: all four completed banks have exact assigned-target and tier order, five questions per category, and unique category/question/fact/subject keys. Scoped Literature ESLint, `git diff --check`, 3 focused files / 226 tests, and `npm run typecheck` all pass. Durable handoff commit `71e48a4` records this accepted primary state.
- Task 5 Art recovery checkpoints 1–3 are independently approved through `9d674d4`: 33 medium categories / 165 clues. Checkpoint 4 exhausted all five repair rounds at `8ffb475` and remains terminally unapproved because 11/169 semantic dispositions are unsupported (Marilyn paired panels, Bird tapering, Equivalent VIII Tate purchase, two London Bridge claims, euro-sign winning design, two Amber Room claims, Nefertiti tall crown, Dying Gaul collapsing, Great Zimbabwe medieval). Do not start Art checkpoint 5 or integrate this lane; 235 categories remain unapproved.
- Task 6 Food & Drink is complete and independently approved through `098f5d0`: all six recovery checkpoints cover 67 categories / 335 clues (33 medium / 34 hard), with no remaining Critical/Important/Minor finding. Final checkpoint 6 binds 157 atomic / 60 Adult / 60 teaching / 12 ramp decisions to exact identities and passed 60/60 sources, mutation/preservation gates, lint/typecheck, 153 focused tests, and a clean standard 1,056-test full suite. Technology, Politics/Economics/Society, and Mythology/Religion/Philosophy still contain 201 rejected categories, so the packs-09-to-12 lane remains non-integrable and must not be cherry-picked into primary.
- Next: preserve the complete Food checkpoint boundary and continue only independently approved remaining recovery work in Technology, Politics/Economics/Society, and Mythology/Religion/Philosophy. Do not cherry-pick Art or packs-09-to-12 lanes into primary or rebuild accepted artifacts until every owning bank is approved. Final acceptance is Windows-only; Linux issues remain out of scope.
- Resume from `.superpowers/sdd/2026-08-28-playable-medium-hard-corpus-overhaul/progress.md`; do not redo easy publication, Adult/Estonia integration, any completed Task 4 bank, Art checkpoints 1–3, or any Food checkpoint.
